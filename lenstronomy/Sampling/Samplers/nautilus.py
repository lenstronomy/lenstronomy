...
class Nautilus(object):
    ...
    def nautilus_sampling(self, prior_type='uniform', mpi=False, thread_count=1):
        """
        ...
        # TODO add MPI pool to Nautilus sampler
        sampler = Sampler(prior, likelihood=self.likelihood)
