    ...
    def fit_sequence(self, fitting_list, fitting_kwargs_list):
        ...
        for i, fitting_type in enumerate(fitting_list):
            if fitting_type == 'restart':
                ...
                lens_result, source_result, lens_light_result, ps_result, cosmo_result, chain, param_list = self.pso(**fitting_kwargs_list[i])
                ...
                samples, param_list, dist_mcmc = self.mcmc(**fitting_kwargs_list[i])
            else:
