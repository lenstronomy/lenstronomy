...
class TestUpdateManager(object):
    ...
    def test_none_mamager(self):
        manager = MultiBandUpdateManager(
            kwargs_model={},
            kwargs_constraints={},
            kwargs_likelihood={},
            kwargs_params={},
    ...
    def test_update_kwargs_model(self):
        kwargs_model = {
            ...
            "source_redshift_list": [2.0],
        }
        kwargs_constraints = {
            "lens_redshift_sampling_indexes": [-1, 1],
    ...
    def test_update_parameter_state(self):
        self.manager.update_param_state(
            kwargs_lens=[{"e1": -2, "e2": 0}, {"e1": 2, "e2": 0}]
        )
    ...
    def test_update_sigmas(self):
        self.manager.update_sigmas(
            change_sigma_source=[[0, ["test"], [1]]],
