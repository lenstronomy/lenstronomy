...
def test_ImageModel_with_primary_beam_and_interferometry_psf():
    ...
    lens_light_without_pb_image1 = imageModel_with_psf_without_pb.lens_surface_brightness(
    ...
    image_without_pb_image2 = imageModel_with_pb_psf.image(
        kwargs_lens, kwargs_source,kwargs_lens_light, unconvolved=True, apply_primary_beam=False
    )
