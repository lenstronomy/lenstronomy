...
class TestSersic(object):
    ...
    def test_total_flux(self):
        delta_pix = 0.1
        x_grid, y_grid = util.make_grid(num_pix=400, delta_pix=delta_pix)
        r_eff = 1
        I_eff = 1.0
        n_sersic = 2
        ...
        flux_numeric = np.sum(flux_grid) * delta_pix**2
        ...
        flux_numeric_ell = np.sum(flux_grid) * delta_pix**2
    ...
    def test_qphi(self):
        ...
        values_qphi = self.sersic_elliptic_qphi.function(
            x, y, I0_sersic, R_sersic, n_sersic, q, phi_G, center_x, center_y
        )
