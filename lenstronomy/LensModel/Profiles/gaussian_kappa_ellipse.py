...
class GaussianKappaEllipse(object):
    ...
    def function(self, x, y, amp, sigma, e1, e2, center_x=0, center_y=0):
        ...
        f_ = self.spherical.function(x_, y_, amp=amp, sigma_x=sigma, sigma_y=sigma)
        return f_
    ...
    def derivatives(self, x, y, amp, sigma, e1, e2, center_x=0, center_y=0):
        ...
        f_x_prim, f_y_prim = self.spherical.derivatives(x_, y_, amp=amp, sigma_x=sigma, sigma_y=sigma)
    ...
    def density_2d(self, x, y, amp, sigma, e1, e2, center_x=0, center_y=0):
        ...
        :return:
        """
        return self.spherical.density_2d(x, y, amp, sigma, sigma, center_x, center_y)
    ...
    def mass_2d_lens(self, R, amp, sigma, e1, e2):
        ...
        :return:
        """
        return self.spherical.mass_2d_lens(R, amp, sigma, sigma)
