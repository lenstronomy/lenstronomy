...
class GalkinMultiObservation(GalkinModel):
    """Class to efficiently model the velocity dispersion measurement of a set
    of different observations with individual apertures and seeing conditions
    for a given lens.

    The main difference to the Galkin main class is that it feeds in
    list of observational settings. Does not work with IFU observations
    (yet)
    """
