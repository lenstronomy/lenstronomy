...
import pytest
from lenstronomy.LightModel.Profiles.shapelets_polar import ShapeletsPolar, ShapeletSetPolar
...
class TestShapeletSetPolar(object):
    ...
    def test_index2_poly(self):
        ...
        index = 0
        n, m, complex_bool = self.shapeletSet._index2poly(index)
        assert n == 0
        assert m == 0
        ...
        index_new = self.shapeletSet._poly2index(n, m, complex_bool)
    ...
    def test__index2n(self):
        index = 0
        n = self.shapeletSet._index2n(index)
        assert n == 0
        index = 1
        n = self.shapeletSet._index2n(index)
        assert n == 1
