...
class PointSourceCached(object):
    """This class is the same as PointSource() except that it saves image and
    ...
    def source_position(self, kwargs_ps, kwargs_lens=None):
        ...
        :param kwargs_lens: lens model keyword argument list (only used
            when required)
        :return: x, y position
        """
        if (
    ...
    def source_amplitude(self, kwargs_ps, kwargs_lens=None):
        ...
        :param kwargs_ps: keyword arguments of the point source model
        :param kwargs_lens: keyword argument list of the lens model(s),
            only used when positions are defined in image plane and have
            to be ray-traced back
