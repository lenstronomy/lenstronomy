__author__ = "sibirrer"
"""This class contains physical constants and conversion factors between
units."""
import numpy as np
...
def delay_arcsec2days(delay_arcsec, ddt):
    """Given a delay in arcsec^2 and a Delay distance, the delay is computed in
    days.

    :param delay_arcsec: gravitational delay in units of arcsec^2 (e.g.
        Fermat potential)
