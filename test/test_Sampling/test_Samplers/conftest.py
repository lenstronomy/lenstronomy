...
def simple_einstein_ring_likelihood():
    ...
    kwargs_data = sim_util.data_configure_simple(num_pix, deltaPix, exp_time, sigma_bkg)
    ...
    image_sim = sim_util.simulate_simple(
        imageModel, kwargs_lens, kwargs_source, kwargs_lens_light
    )
    ...
    kwargs_fixed_lens = [
        {"gamma": 1.8, "center_x": 0, "center_y": 0, "e1": 0.1, "e2": 0.1}
    ]
...
def simple_einstein_ring_likelihood_2d():
    ...
    kwargs_fixed_lens_light = [
        {"R_sersic": 0.1, "n_sersic": 2, "center_x": 0, "center_y": 0}
    ]
