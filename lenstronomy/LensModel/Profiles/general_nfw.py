...
class GNFW(LensProfileBase):
    """
    This class contains a generalized NFW-like profile with flexible inner and outer logarithmic slopes g and n
    ...
    def density(self, R, Rs, rho0, gamma_inner, gamma_outer):
        ...
        """
        x = R/Rs
        return rho0 / (x**gamma_inner * (1 +x ** 2) ** (gamma_outer-gamma_inner)/2)
