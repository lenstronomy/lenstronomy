...
class TestNIE_simple(object):
        ...
        def test_function(self):
            ...
            s = 0.00001
            phi_G = 0
            values = self.nie.function(x, y, theta_E, q=q, s=s)
        ...
        def test_derivatives(self):
            ...
            q = 0.99999
            s = 0.0000001
            f_x, f_y = self.nie.derivatives(x, y, theta_E, q=q, s=s)
        ...
        def test_hessian(self):
            ...
            q = 0.999999
            s = 0.0000001
            f_xx, f_yy, f_xy = self.nie.hessian(x, y, theta_E, q=q, s=s)
