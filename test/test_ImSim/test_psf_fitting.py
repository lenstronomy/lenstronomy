...
class TestImageModel(object):
    ...
    def setup(self):
        ...
        image_sim = self.SimAPI.im_sim(self.kwargs_options, kwargs_data, kwargs_psf, self.kwargs_lens,
                                       self.kwargs_source,
    ...
    def test_update_psf(self):
        ...
        kwargs_psf_return, improved_bool = self.psf_fitting.update_psf(self.kwargs_data, kwargs_psf,
                                                                       self.kwargs_options, self.kwargs_lens,
                                                                       self.kwargs_source, self.kwargs_lens_light,
    ...
    def test_update_iterative(self):
        ...
        kwargs_psf = self.SimAPI.psf_configure(psf_type='PIXEL', fwhm=fwhm, kernelsize=31, deltaPix=0.05,
                                               truncate=6,
                                               kernel=kwargs_psf['kernel_point_source'])
        kwargs_psf_new = self.psf_fitting.update_iterative(self.kwargs_data, kwargs_psf, self.kwargs_options,
