...
class TestParam(object):
    def setup_method(self):
        self.param = SpecialParam(
            ...
            kwargs_upper={"z_sampling": [0.2, 1.0, 1.0]},
        )
        self.kwargs = {
            "D_dt": 1988,
            "delta_x_image": [0, 0],
    ...
    def test_mass_scaling(self):
        kwargs_fixed = {}
        param = SpecialParam(
            kwargs_fixed=kwargs_fixed, mass_scaling=True, num_scale_factor=3
        )
    ...
    def test_source_grid_offsets(self):
        param = SpecialParam(
            kwargs_lower={"delta_x_source_grid": -1, "delta_y_source_grid": 1},
    ...
    def test_general_scaling(self):
        ...
        args = param.set_params(
            {"param_scale_factor": [1, 2], "param_scale_pow": [3, 4]}
        )
        assert len(args) == 4
        num_param, param_list = param.num_param()
        assert num_param == 4
