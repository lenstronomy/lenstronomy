...
class CriticalCurve(object):
    ...
    def _stretch2profile(tangential_stretch, radial_stretch, r_curvature):
        ...
        """
        gamma = (1./radial_stretch - 1) * (1/tangential_stretch -1)**(-1) - 2
        theta_E = (1./radial_stretch - 1)**(-gamma + 1) * r_curvature
    ...
    def derivatives(self, x, y, tangential_stretch, radial_stretch, r_curvature, direction, center_x, center_y):
        ...
        return self._spp.derivatives(x, y, theta_E, gamma, center_x_spp, center_y_spp) - self._spp.derivatives(center_x, center_y, theta_E, gamma, center_x_spp, center_y_spp)
    ...
    def hessian(self, x, y, tangential_stretch, radial_stretch, r_curvature, direction, center_x, center_y):
        ...
        theta_E, gamma, center_x_spp, center_y_spp = self._input2spp_parameterization(tangential_stretch,
                                                                                      radial_stretch, r_curvature,
                                                                                      direction, center_x, center_y)
        return self._spp.hessian(x, y, theta_E, gamma, center_x_spp, center_y_spp) - self._spp.hessian(center_x, center_y, theta_E, gamma, center_x_spp, center_y_spp)
