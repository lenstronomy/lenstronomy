...
class TestLensModelExtensions(object):
    ...
    def test_radial_tangential_differentials(self):
        ...
        radial_stretch, tangential_stretch, d_tang_d_tang, d_angle_d_tang, d_rad_d_rad, d_angle_d_rad, orientation_angle = extensions.radial_tangential_differentials(x, y, kwargs_lens, smoothing_3rd=0.001)
        ...
        extensions = LensModelExtensions(lensModel=lens)
        radial_stretch, tangential_stretch, d_tang_d_tang, d_angle_d_tang, d_rad_d_rad, d_angle_d_rad, orientation_angle = extensions.radial_tangential_differentials(2, 2, kwargs_lens, smoothing_3rd=0.001)
