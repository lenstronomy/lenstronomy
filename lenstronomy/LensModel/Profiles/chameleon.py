...
class Chameleon(LensProfileBase):
    ...
    def function(self, x, y, alpha_1, w_c, w_t, e1, e2, center_x=0, center_y=0):
        ...
        f_1 = self._nie_1.function(
            x, y, theta_E_conv, e1, e2, s_scale_1, center_x, center_y
        )
        f_2 = self._nie_2.function(
            x, y, theta_E_conv, e1, e2, s_scale_2, center_x, center_y
        )
        f_ = f_1 - f_2
        return f_
    ...
    def derivatives(self, x, y, alpha_1, w_c, w_t, e1, e2, center_x=0, center_y=0):
        ...
        f_x_1, f_y_1 = self._nie_1.derivatives(
            x, y, theta_E_conv, e1, e2, s_scale_1, center_x, center_y
        )
        f_x_2, f_y_2 = self._nie_2.derivatives(
            x, y, theta_E_conv, e1, e2, s_scale_2, center_x, center_y
        )
        f_x = f_x_1 - f_x_2
        f_y = f_y_1 - f_y_2
    ...
    def hessian(self, x, y, alpha_1, w_c, w_t, e1, e2, center_x=0, center_y=0):
        ...
        f_xx_1, f_xy_1, f_yx_1, f_yy_1 = self._nie_1.hessian(
            x, y, theta_E_conv, e1, e2, s_scale_1, center_x, center_y
        )
        f_xx_2, f_xy_2, f_yx_2, f_yy_2 = self._nie_2.hessian(
            x, y, theta_E_conv, e1, e2, s_scale_2, center_x, center_y
        )
        f_xx = f_xx_1 - f_xx_2
        f_yy = f_yy_1 - f_yy_2
    ...
    def mass_3d_lens(self, r, alpha_1, w_c, w_t, e1=0, e2=0, center_x=0, center_y=0):
        ...
        m_1 = self._nie_1.mass_3d_lens(
            r, theta_E_conv, e1, e2, s_scale_1, center_x, center_y
        )
        m_2 = self._nie_2.mass_3d_lens(
            r, theta_E_conv, e1, e2, s_scale_2, center_x, center_y
        )
        m_ = m_1 - m_2
        return m_
    ...
    def _param_convert(self, alpha_1, w_c, w_t, e1, e2):
        ...
        s_scale_2 = w_t
        f_x_1, f_y_1 = self._nie_1.derivatives(
            1, 0, theta_E=1, e1=0, e2=0, s_scale=s_scale_1
        )
        f_x_2, f_y_2 = self._nie_2.derivatives(
            1, 0, theta_E=1, e1=0, e2=0, s_scale=s_scale_2
        )
        f_x = f_x_1 - f_x_2
        ...
        s_scale_1 = np.sqrt(4 * w_c**2 / (1.0 + q) ** 2)
        s_scale_2 = np.sqrt(4 * w_t**2 / (1.0 + q) ** 2)
    ...
    def set_static(self, alpha_1, w_c, w_t, e1, e2, center_x=0, center_y=0):
        ...
        (
            ...
            self._s_scale_1_static,
            self._s_scale_2_static,
        ) = self._param_convert(alpha_1, w_c, w_t, e1, e2)
...
class DoubleChameleon(LensProfileBase):
    ...
    def function(
        ...
        f_2 = self._chameleon_2.function(
            x, y, alpha_1 / (1.0 + ratio), w_c2, w_t2, e12, e22, center_x, center_y
        )
        return f_1 + f_2
    ...
    def derivatives(
        ...
        f_x2, f_y2 = self._chameleon_2.derivatives(
            x, y, alpha_1 / (1.0 + ratio), w_c2, w_t2, e12, e22, center_x, center_y
        )
    ...
    def hessian(
        ...
        f_xx2, f_xy2, f_yx2, f_yy2 = self._chameleon_2.hessian(
            x, y, alpha_1 / (1.0 + ratio), w_c2, w_t2, e12, e22, center_x, center_y
        )
    ...
    def density_lens(
        ...
        f_2 = self._chameleon_2.density_lens(
            r, alpha_1 / (1.0 + ratio), w_c2, w_t2, e12, e22, center_x, center_y
        )
        return f_1 + f_2
    ...
    def mass_3d_lens(
        ...
        m_2 = self._chameleon_2.mass_3d_lens(
            r, alpha_1 / (1.0 + ratio), w_c2, w_t2, e12, e22, center_x, center_y
        )
        return m_1 + m_2
    ...
    def set_static(
        ...
        self._chameleon_1.set_static(
            alpha_1 / (1.0 + 1.0 / ratio), w_c1, w_t1, e11, e21, center_x, center_y
        )
        self._chameleon_2.set_static(
            alpha_1 / (1.0 + ratio), w_c2, w_t2, e12, e22, center_x, center_y
        )
...
class TripleChameleon(LensProfileBase):
    ...
    def function(
        ...
        f_3 = self._chameleon_3.function(
    ...
    def derivatives(
        ...
        f_x3, f_y3 = self._chameleon_3.derivatives(
            x, y, amp3, w_c3, w_t3, e13, e23, center_x, center_y
        )
    ...
    def hessian(
        ...
        """
        amp1, amp2, amp3 = self._ratio_definition(alpha_1, ratio12, ratio13)
        f_xx1, f_xy1, f_yx1, f_yy1 = self._chameleon_1.hessian(
            x, y, amp1, w_c1, w_t1, e11, e21, center_x, center_y
        )
        f_xx2, f_xy2, f_yx2, f_yy2 = self._chameleon_2.hessian(
            x, y, amp2, w_c2, w_t2, e12, e22, center_x, center_y
        )
        f_xx3, f_xy3, f_yx3, f_yy3 = self._chameleon_3.hessian(
            x, y, amp3, w_c3, w_t3, e13, e23, center_x, center_y
        )
        return (
            f_xx1 + f_xx2 + f_xx3,
    ...
    def density_lens(
        ...
        amp1, amp2, amp3 = self._ratio_definition(alpha_1, ratio12, ratio13)
        f_1 = self._chameleon_1.density_lens(
            r, amp1, w_c1, w_t1, e11, e21, center_x, center_y
        )
        f_2 = self._chameleon_2.density_lens(
            r, amp2, w_c2, w_t2, e12, e22, center_x, center_y
        )
        f_3 = self._chameleon_3.density_lens(
            r, amp3, w_c3, w_t3, e13, e23, center_x, center_y
        )
        return f_1 + f_2 + f_3
    ...
    def mass_3d_lens(
        ...
        m_3 = self._chameleon_3.mass_3d_lens(
            r, amp3, w_c3, w_t3, e13, e23, center_x, center_y
        )
        return m_1 + m_2 + m_3
...
class DoubleChameleonPointMass(LensProfileBase):
    ...
    def function(
        ...
        :return: lensing potential
        """
        f_1 = self.pointMass.function(
            x, y, alpha_1 / (1.0 + 1.0 / ratio_pointmass), center_x, center_y
        )
        f_2 = self.chameleon.function(
            x,
            y,
            alpha_1 / (1.0 + ratio_pointmass),
            ratio_chameleon,
            w_c1,
            w_t1,
            e11,
    ...
    def hessian(
        ...
        :return:
        """
        f_xx1, f_xy1, f_yx1, f_yy1 = self.pointMass.hessian(
            x, y, alpha_1 / (1.0 + 1.0 / ratio_pointmass), center_x, center_y
        )
        f_xx2, f_xy2, f_yx2, f_yy2 = self.chameleon.hessian(
            x,
            y,
            alpha_1 / (1.0 + ratio_pointmass),
            ratio_chameleon,
