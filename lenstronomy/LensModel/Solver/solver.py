...
class Solver(object):
    ...
    def __init__(self, solver_type, lensModel, num_images):
        """:param solver_type: string, option for specific solver type see detailed
        instruction of the Solver4Point and Solver2Point classes :param lensModel:
        instance of a LensModel() class :param num_images: int, number of images to be
        solved for."""
    ...
    def constraint_lensmodel(self, x_pos, y_pos, kwargs_list, xtol=1.49012e-12):
        """:param x_pos: x-position constraints on images :param y_pos: y-position
        constraints on images :param kwargs_list: lens model keyword argument list
    ...
    def update_solver(self, kwargs_lens, x_pos, y_pos):
        """:param kwargs_lens: lens model keyword argument list :param x_pos: x-position
        constraints on images :param y_pos: y-position constraints on images :return:
