...
class TestCurvedArcSPT(object):
    ...
    def test_function(self):
        ...
        npt.assert_raises(Exception, self._curve_spt.function, 0.0, 0.0, **kwargs_arc)
    ...
    def test_spt_mapping(self):
        ...
        x, y = util.make_grid(num_pix=100, deltapix=0.01)
        ...
        kwargs_source = [
            {"amp": 1, "sigma": 0.05, "center_x": 0, "center_y": 0, "e1": 0, "e2": 0}
        ]
