...
class Params(object):
    ...
    def __init__(self,zlist=None, lens_list=None, arg_list=None,
        ...
        self.tovary_lower_limit,self.tovary_upper_limit = routine.get_param_ranges(initialized)
