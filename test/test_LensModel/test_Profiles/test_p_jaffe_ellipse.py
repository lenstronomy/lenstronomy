...
class TestP_JAFFW(object):
    ...
    def test_function(self):
        ...
        Ra, Rs = 0.5, 0.8
        q, phi_G = 0.8, 0
        values = self.profile.function(x, y, sigma0, Ra, Rs, q, phi_G, center_x=0, center_y=0)
    ...
    def test_derivatives(self):
        ...
        Ra, Rs = 0.5, 0.8
        q, phi_G = 0.8, 0
        f_x, f_y = self.profile.derivatives( x, y, sigma0, Ra, Rs, q, phi_G, center_x=0, center_y=0)
        ...
        x = np.array([1,3,4])
        y = np.array([2,1,1])
        values = self.profile.derivatives(x, y, sigma0, Ra, Rs, q, phi_G, center_x=0, center_y=0)
    ...
    def test_hessian(self):
        ...
        Ra, Rs = 0.5, 0.8
        q, phi_G = 0.8, 0
        f_xx, f_yy,f_xy = self.profile.hessian(x, y, sigma0, Ra, Rs, q, phi_G, center_x=0, center_y=0)
        assert f_xx[0] == 0.064049581333103234
        assert f_yy[0] == -0.054062473386906618
        assert f_xy[0] == -0.060054723013958089
        x = np.array([1,3,4])
        y = np.array([2,1,1])
        values = self.profile.hessian(x, y, sigma0, Ra, Rs, q, phi_G, center_x=0, center_y=0)
