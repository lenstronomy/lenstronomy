...
class ShapeletSetEllipse(object):
    ...
    def function(self, x, y, amp, n_max, beta, e1, e2, center_x=0, center_y=0):
        ...
        :param e1: eccentricity component 1 :param e2: eccentricity component 2 :param
        center_x: shapelet center x :param center_y: shapelet center y :return: surface
        brightness of combined shapelet set."""
