...
class TestPositionLikelihood(object):
    ...
    def test_source_position_rms_scatter(self):
        ...
        kwargs_ps_init = {
            "ra_image": kwargs_ra_image_list,
            "dec_image": kwargs_dec_image_list,
        }
        fixed_ps = {
            "ra_image": kwargs_ra_image_list,
            "dec_image": kwargs_dec_image_list,
        ...
        lens_params = [
            kwargs_lens_init,
            fixed_lens,
        ]  # kwargs_lens_sigma, fixed_lens, kwargs_lower_lens, kwargs_upper_lens]
        ps_params = [
            kwargs_ps_init,
            fixed_ps,
        ]  # kwargs_ps_sigma, fixed_ps, kwargs_lower_ps, kwargs_upper_ps]
        special_params = [
            kwargs_special_init,
            fixed_special,
        ]  # kwargs_special_sigma, fixed_special, kwargs_lower_special, kwargs_upper_special]
