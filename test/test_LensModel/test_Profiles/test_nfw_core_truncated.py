...
class TestTNFWC(object):
    ...
    def test_alphaRs(self):
        ...
        alpha_rs = self.tnfwc.derivatives(
            kwargs_lens["Rs"],
            0.0,
            kwargs_lens["Rs"],
            kwargs_lens["alpha_Rs"],
            kwargs_lens["r_core"],
            kwargs_lens["r_trunc"],
        )[0]
    ...
    def test_alphaRs_rho0_conversion(self):
        ...
        rho0 = self.tnfwc.alpha2rho0(
            kwargs_lens["alpha_Rs"],
            kwargs_lens["Rs"],
            kwargs_lens["r_core"],
            kwargs_lens["r_trunc"],
        )
        alpha_Rs = self.tnfwc.rho02alpha(
            rho0, kwargs_lens["Rs"], kwargs_lens["r_core"], kwargs_lens["r_trunc"]
        )
