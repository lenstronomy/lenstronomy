...
class Solver(object):
    """Joint solve class to manage with type of solver to be executed and
    ...
    def check_solver(self, image_x, image_y, kwargs_lens):
        ...
        :param kwargs_lens: full lens model (including solved
            parameters)
        :param image_x: point source in image
        :param image_y: point source in image
        :return: precision of Euclidean distances between the different
            rays arriving at the image positions
        """
    ...
    def add_fixed_lens(self, kwargs_fixed_lens, kwargs_lens_init):
        ...
        :param kwargs_fixed_lens: keyword argument list of fixed
            parameters (indicated by fitting argument of the user)
        :param kwargs_lens_init: Initial values of the full lens model
            keyword arguments
        :return: updated kwargs_fixed_lens, added fixed parameters being
            added (and replaced later on) by the non-linear solver.
        """
