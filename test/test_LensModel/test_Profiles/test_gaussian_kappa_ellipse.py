...
class TestGaussianKappa(object):
    ...
    def test_function(self):
        ...
        f_sphere = self.gaussian_kappa.function(x, y, amp=amp, sigma_x=sigma, sigma_y=sigma)
    ...
    def test_derivatives(self):
        ...
        f_x_sphere, f_y_sphere = self.gaussian_kappa.derivatives(x, y, amp=amp, sigma_x=sigma, sigma_y=sigma)
    ...
    def test_hessian(self):
        ...
        f_xx_sphere, f_yy_sphere, f_xy_sphere = self.gaussian_kappa.hessian(x, y, amp=amp, sigma_x=sigma, sigma_y=sigma)
    ...
    def test_density_2d(self):
        ...
        f_sphere = self.gaussian_kappa.density_2d(x, y, amp=amp, sigma_x=sigma, sigma_y=sigma)
        npt.assert_almost_equal(f_, f_sphere, decimal=8)
    ...
    def test_mass_2d(self):
        ...
        f_sphere = self.gaussian_kappa.mass_2d(r, amp=amp, sigma_x=sigma, sigma_y=sigma)
        npt.assert_almost_equal(f_, f_sphere, decimal=8)
    ...
    def test_mass_2d_lens(self):
        ...
        f_sphere = self.gaussian_kappa.mass_2d_lens(r, amp=amp, sigma_x=sigma, sigma_y=sigma)
        npt.assert_almost_equal(f_, f_sphere, decimal=8)
