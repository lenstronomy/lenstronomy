...
class TestNFWMC(object):
    ...
    def test_derivatives(self):
        ...
        logM = 12
        concentration = 10
        f_x_mc, f_y_mc = self.nfwmc.derivatives(
            x, y, logM, concentration, center_x=0, center_y=0
        )
        Rs, alpha_Rs = self.lensCosmo.nfw_physical2angle(10**logM, concentration)
    ...
    def test_hessian(self):
        ...
        logM = 12
        concentration = 10
        f_xx_mc, f_xy_mc, f_yx_mc, f_yy_mc = self.nfwmc.hessian(
            x, y, logM, concentration, center_x=0, center_y=0
        )
        Rs, alpha_Rs = self.lensCosmo.nfw_physical2angle(10**logM, concentration)
        f_xx, f_xy, f_yx, f_yy = self.nfw.hessian(
            x, y, Rs, alpha_Rs, center_x=0, center_y=0
        )
