...
class Linear(object):
    ...
    def __init__(self):
        ...
        self.lower_limit_default = {'k': -1000, 'amp': 0, 'center_x': -100, 'center_y': -100}
        self.upper_limit_default = {'k': 1000, 'amp': 100, 'center_x': 100, 'center_y': 100}
...
class LinearEllipse(object):
    ...
    lower_limit_default = {'k': -1000, 'amp': 0, 'e1': -0.5, 'e2': -0.5, 'center_x': -100, 'center_y': -100}
    upper_limit_default = {'k': 1000, 'amp': 100, 'e1': -0.5, 'e2': -0.5, 'center_x': 100, 'center_y': 100}
