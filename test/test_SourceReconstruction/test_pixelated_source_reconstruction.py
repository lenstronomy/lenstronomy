...
=======
        ...
        b_expected = np.array(
            [0.44319784, 0.60691129, 0.60445714, 1.00888506, 0.80968046, 1.37626347]
        )
        assert np.allclose(M_expected, M_result, atol=1e-5)
        assert np.allclose(b_expected, b_result, atol=1e-5)
...
=======
        ...
        M_expected = np.array(
            [
                [0.02229289, 0.0221506, 0.0221506, 0.03531318, 0.01467593, 0.02430386],
        ...
        b_expected = np.array(
            [0.84629238, 0.8555345, 0.93490381, 1.09044392, 1.06591831, 1.55618881]
        )
        assert np.allclose(M_expected, M_result, atol=1e-5)
        assert np.allclose(b_expected, b_result, atol=1e-5)
