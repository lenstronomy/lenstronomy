...
class MultiPlane(object):
    ...
    def __init__(self, z_source, lens_model_list, redshift_list, cosmo=None, kwargs_lensmodel = {}):
        """
        ...
        self._lens_model = SinglePlane(lens_model_list, kwargs_lensmodel = kwargs_lensmodel)
        z_before = 0
        self._T_ij_list = []
        self._T_z_list = []
