...
class SingleBandMultiSparseModel(SingleBandMultiModelBase, ImageSparseFit):
    """
    ...
    def __init__(self, multi_band_list, kwargs_model, likelihood_mask_list=None, band_index=0, 
        ...
        data_i, psf_i, lens_model_class, source_model_class, lens_light_model_class, \
            ...
            = self.select_image_fit(multi_band_list, kwargs_model, likelihood_mask_list=likelihood_mask_list, 
                                    band_index=band_index)
        ImageSparseFit.__init__(self, data_i, psf_i, lens_model_class, source_model_class,
    ...
    def image_sparse_solve(self, kwargs_lens=None, kwargs_source=None, kwargs_lens_light=None, kwargs_ps=None,
        ...
        """
        kwargs_lens_i, kwargs_source_i, kwargs_lens_light_i, kwargs_ps_i, _ = self.select_kwargs(kwargs_lens,
                                                                                              kwargs_source,
                                                                                              kwargs_lens_light,
                                                                                              kwargs_ps,
                                                                                              None)
