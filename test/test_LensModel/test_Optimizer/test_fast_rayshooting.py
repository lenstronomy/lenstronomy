...
class TestFastRayShooting(object):
    def setup_method(self):
        ...
        halo_kwargs = [
            {"theta_E": 0.05, "center_x": 0.3, "center_y": -0.9},
    ...
    def test_rayshooting(self):
        ...
        x_inner, y_inner = fast_rayshooting.lensModel.ray_shooting(
            x_image_true, y_image_true, self.kwargs_epl
        )
        ...
        fast_rayshooting_new = MultiplaneFast(
            x_image_true,
            y_image_true,
            self.zlens,
            self.zsource,
