...
class AngularSensitivity(object):
    ...
    This class provides functions describing the EM radiation sensitivity along
    different directions of some specific telescopes, including radio antennae of an
