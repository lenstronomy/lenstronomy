...
class Shift(LensProfileBase):
    ...
    def function(self, x, y, alpha_x, alpha_y):
        ...
        plane (angle) :param alpha_x: shift in x-direction (angle) :param alpha_y: shift
        in y-direction (angle) :return: lensing potential."""
    ...
    def derivatives(self, x, y, alpha_x, alpha_y):
        """:param x: coordinate in image plane (angle) :param y: coordinate in image
        plane (angle) :param alpha_x: shift in x-direction (angle) :param alpha_y: shift
        in y-direction (angle) :return: deflection in x- and y-direction."""
    ...
    def hessian(self, x, y, alpha_x, alpha_y):
        """:param x: coordinate in image plane (angle) :param y: coordinate in image
        plane (angle) :param alpha_x: shift in x-direction (angle) :param alpha_y: shift
        in y-direction (angle) :return: hessian elements f_xx, f_xy, f_yx, f_yy."""
