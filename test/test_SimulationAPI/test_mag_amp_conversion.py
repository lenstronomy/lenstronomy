...
class TestMagAmpConversion(object):
    ...
    def setup_method(self):
        ...
        self.mag_amp = MagAmpConversion(kwargs_model=kwargs_model, magnitude_zero_point=self.mag_zero_point)

    def test_magnitude2amplitude(self):
        # input with nones
        kwargs_lens_light, kwargs_source, kwargs_ps = self.mag_amp.magnitude2amplitude(kwargs_lens_light_mag=None,
        ...
        kwargs_lens_light = [{"magnitude": self.mag_zero_point, "sigma": 1,
                              "center_x": 0, "center_y": 0}]
        kwargs_source = [{"magnitude": self.mag_zero_point -1, "sigma": 1,
                              "center_x": 0, "center_y": 0}]
        kwargs_ps = [{"magnitude": self.mag_zero_point, "ra_source": 0, "dec_source": 0}]

        kwargs_lens_light_amp, kwargs_source_amp, kwargs_ps_amp = self.mag_amp.magnitude2amplitude(kwargs_lens_light_mag=kwargs_lens_light,
