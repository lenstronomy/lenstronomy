...
class ModelBandPlot(ModelBand):
    ...
    def __init__(
        ...
        :param kwargs_params: keyword argument of keyword argument lists of the
            different model components selected for
        :type kwargs_params: dict the imaging band, NOT including linear amplitudes (not
        ...
        :param linear_solver: If True (default) fixes the linear amplitude parameters
            'amp' (avoid sampling) such
        :type linear_solver: bool that they get overwritten by the linear solver
            solution.
        """
        ModelBand.__init__(
            self,
