...
class FixedShearPowerLaw(object):
    ...
    def __init__(self, lens_model_list, kwargs_lens, xpos, ypos):
        ...
        self._tovary_indicies = [0, 1]
        self.param_names = [['theta_E', 'center_x', 'center_y', 'e1', 'e2', 'gamma'], ['e1', 'e2']]
        self.fixed_names = [['gamma'], ['e1','e2']]
        self.fixed_values = [{'gamma': kwargs_lens[0]['gamma']}, {'e1': kwargs_lens[1]['e1'], 'e2': kwargs_lens[1]['e2']}]
        self.params_to_vary = ['theta_E', 'center_x', 'center_y', 'e1', 'e2']
    ...
    def get_param_ranges(self, reoptimize=False, scale=1):
        ...
        return sie_list_low, sie_list_high
