...
def data_configure_simple(
    ...
    """Configures the data keyword arguments with a coordinate grid centered at
    zero.
    ...
    :param inverse: if True, coordinate system is ra to the left, if
        False, to the right
    :return: keyword arguments that can be used to construct a Data()
        class instance of lenstronomy
    """
