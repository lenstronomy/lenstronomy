...
- Updated ``seeing`` values to DP1-era measured atmospheric medians from
  Rubin Observatory Technical Note RTN-095 (2025), replacing design-spec
  estimates from the original source spreadsheet.
...
# exposure_time : 30 s (two 15 s snaps, standard LSST visit)
# num_exposures : OpSim v3.0 WFD 10-year baseline (Bianco et al. 2022)
# seeing        : DP1 measured atmospheric medians (RTN-095, 2025)
# ---------------------------------------------------------------------------
...
class LSST(object):
    ...
    def kwargs_single_band(self):
        ...
        """
        return util.merge_dicts(self.obs)
