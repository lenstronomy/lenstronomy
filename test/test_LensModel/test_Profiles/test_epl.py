...
class TestEPLvsNIE(object):
    ...
    def test_function(self):
        ...
        values_nie = self.NIE.function(x, y, phi_E, e1, e2, 0.0)
    ...
    def test_derivatives(self):
        ...
        f_x_nie, f_y_nie = self.NIE.derivatives(x, y, phi_E, e1, e2, 0.0)
    ...
    def test_static(self):
        ...
        phi_G, q = 0.3, 0.8
        e1, e2 = param_util.phi_q2_ellipticity(phi_G, q)
        kwargs_lens = {"theta_E": 1.0, "gamma": 1.5, "e1": e1, "e2": e2}
        ...
        kwargs_lens = {"theta_E": 2.0, "gamma": 1.9, "e1": e1, "e2": e2}
...
class TestEPLvsPEMD(object):
    ...
    def test_epl_pemd_convention(self):
        ...
        if self._fastell4py_bool is False:
            ...
            x, y = util.make_grid(num_pix=10, deltapix=0.2)
            ...
            for e1 in e1_list:
                for e2 in e2_list:
                    ...
                    for theta_E in theta_E_list:
                        ...
                        f_x_qphi, f_y_qphi = self.epl_qphi.derivatives(
                            x, y, **kwargs_qphi
                        )
