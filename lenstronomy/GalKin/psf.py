...
class PSF(object):
    ...
    def __init__(self, psf_type, **kwargs_psf):
        """:param psf_type: string, point spread function type, current support for
        'GAUSSIAN' and 'MOFFAT' :param kwargs_psf: keyword argument describing the
        relevant parameters of the PSF."""
    ...
    def displace_psf(self, x, y):
        """:param x: x-coordinate of light ray :param y: y-coordinate of light ray
...
class PSFMoffat(object):
    ...
    def __init__(self, fwhm, moffat_beta):
        """:param fwhm: full width at half maximum seeing condition :param moffat_beta:
        float, beta parameter of Moffat profile."""
        self._fwhm = fwhm
