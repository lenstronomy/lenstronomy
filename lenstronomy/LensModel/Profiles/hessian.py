...
class Hessian(LensProfileBase):
    """Class for constant Hessian distortion (second order) The input is in the
    same convention as the LensModel.hessian() output."""
    ...
    def hessian(self, x, y, f_xx, f_yy, f_xy, f_yx, ra_0=0, dec_0=0):
        """Hessian. Attention: If f_xy != f_yx then this function is not
        accurate!
