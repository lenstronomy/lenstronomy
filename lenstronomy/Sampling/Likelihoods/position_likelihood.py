...
class PositionLikelihood(object):
    ...
    def source_position_dist(
        ...
        :param z_sources: list of arrays of redshifts for each point source model. Used
            in change_source_redshift function :return diffs_x, diffs_y: lists of floats
    ...
    def source_position_rmse(
        ...
        # ## Setting up the data and calculating the source positions
        dists_x, dists_y = self.source_position_dist(self, kwargs_lens=kwargs_lens, kwargs_ps=kwargs_ps, lens_model=lens_model, z_sources=z_sources)
