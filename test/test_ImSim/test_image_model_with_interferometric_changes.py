...
def test_ImageModel_with_primary_beam_and_interferometry_psf():
    ...
    imageModel_with_psf_without_pb = ImageModel(data_class_no_pb, psf_class, lens_model_class, source_model_class, lens_light_model_class, kwargs_numerics=kwargs_numerics)
    source_without_pb_image1 = imageModel_with_psf_without_pb.source_surface_brightness(kwargs_source, de_lensed=True, unconvolved=True)
    source_without_pb_image2 = imageModel_with_pb_psf.source_surface_brightness(kwargs_source, de_lensed=True, unconvolved=True, apply_primary_beam=False)
    npt.assert_almost_equal(source_without_pb_image1, source_without_pb_image2, decimal=8)
    
    lens_light_without_pb_image1 = imageModel_with_psf_without_pb.lens_surface_brightness(kwargs_lens_light, unconvolved=True)
    lens_light_without_pb_image2 = imageModel_with_pb_psf.lens_surface_brightness(kwargs_lens_light, unconvolved=True, apply_primary_beam=False)
    npt.assert_almost_equal(lens_light_without_pb_image1, lens_light_without_pb_image2, decimal=8)
    
    image_without_pb_image1 = imageModel_with_psf_without_pb.image(kwargs_lens, kwargs_source,kwargs_lens_light, unconvolved=True)
    image_without_pb_image2 = imageModel_with_pb_psf.image(kwargs_lens, kwargs_source,kwargs_lens_light, unconvolved=True, apply_primary_beam=False)
