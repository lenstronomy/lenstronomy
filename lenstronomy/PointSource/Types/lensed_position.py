...
class LensedPositions(PSBase):
    ...
    def image_position(
        ...
        :param magnification_limit: float >0 or None, if float is set
            and additional images are computed, only those images will
            be computed that exceed the lensing magnification (absolute
            value) limit
    ...
    def source_position(self, kwargs_ps, kwargs_lens=None):
        ...
        :param kwargs_lens: lens model keyword argument list (required
            to ray-trace back in the source plane)
