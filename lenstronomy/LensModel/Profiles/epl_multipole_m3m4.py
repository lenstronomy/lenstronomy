...
class EPL_MULTIPOLE_M3M4(LensProfileBase):
    """ EPL (Elliptical Power Law) mass profile combined with two multiple terms of order m=3 and m=4.
    ...
    def _param_split(self, theta_E, gamma, e1, e2, a3_a, delta_phi_m3, a4_a, delta_phi_m4, center_x=0, center_y=0):
        ...
        :param a3_a: amplitude of the m=3 multiple deviation from pure elliptical shape related to the physical
        amplitude of the MULTIPOLE profile by a scaling theta_E / sqrt(q)
        :param delta_phi_m3: orientation of the m=3 profile relative to the position angle of the EPL profile
        :param a4_a: amplitude of the m=4 multipole deviation from pure elliptical shape related to the physical
        amplitude of the MULTIPOLE profile by a scaling theta_E / sqrt(q)
    ...
    def function(self, x, y, theta_E, gamma, e1, e2, a3_a, delta_phi_m3, a4_a, delta_phi_m4, center_x=0, center_y=0):
        ...
        kwargs_epl, kwargs_multipole3, kwargs_multipole4 = self._param_split(
            theta_E, gamma, e1, e2, a3_a, delta_phi_m3, a4_a, delta_phi_m4, center_x=center_x, center_y=center_y
        )
    ...
    def derivatives(self, x, y, theta_E, gamma, e1, e2, a3_a, delta_phi_m3, a4_a, delta_phi_m4, center_x=0, center_y=0):
    ...
    def hessian(self, x, y, theta_E, gamma, e1, e2, a3_a, delta_phi_m3, a4_a, delta_phi_m4, center_x=0, center_y=0):
