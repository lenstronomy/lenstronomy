...
__all__ = ['H0Likelihood']


class H0Likelihood(object):
    """
    class to compute the likelihood of a model given a measurement of time delays, sampling h0
    """
