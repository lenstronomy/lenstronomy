...
class PartialImage(object):
    ...
    def __init__(self, partial_read_bools):
        """:param partial_read_bools: 2d numpy array of bools indicating which indexes
        to be processed."""
    ...
    def partial_array(self, image):
        """:param image: 2d array :return: 1d array of partial list."""
        array = util.image2array(image)
        return array[self._partial_read_bools_array]

    @property
    def index_array(self):
        """:return: 2d array with indexes (integers) corresponding to the 1d array, -1
        when masked."""
    ...
    def array_from_partial(self, partial_array):
        """:param partial_array: 1d array of the partial indexes :return: full 1d
        array."""
    ...
    def image_from_partial(self, partial_array):
        """:param partial_array: 1d array corresponding to the indexes of the partial
        read :return: full image with zeros elsewhere."""
