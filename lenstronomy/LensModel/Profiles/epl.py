__author__ = 'ntessore, pierrefleury'
...
__all__ = ['EPL', 'EPLMajorAxis', 'EPL_SHEARED']
...
class EPL(LensProfileBase):
    ...
    def set_static(self, theta_E, gamma, e1, e2, center_x=0, center_y=0):
        ...
        """
        self._static = True
        self._b_static, self._t_static, self._q_static,
        self._phi_G_static = self._param_conv(theta_E, gamma, e1, e2)
...
class EPL_SHEARED(EPL):
    ...
    def shear(self, x, y, gamma1, gamma2, center_x, center_y):
        ...
        :param center_x: profile center
        :param center_y: profile center
        :returns: position that is sheared with respect to the profile center
        """
    ...
    def hessian(self, x, y,
        ...
        H_xx = ( (1 - gamma1)**2 * f_xx
                - 2 * (1 - gamma1) * gamma2 * f_xy
                + gamma2**2 * f_yy)
        H_xy = (- (1 - gamma1) * gamma2 * f_xx
