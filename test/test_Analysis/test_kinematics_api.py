...
class TestKinematicsAPI(object):
    ...
    def test_velocity_dispersion_map_direct_convolved_against_jampy(self):
        ...
        kwargs_lens = [
            {
                "theta_E": 1.6381683017993576,
                "gamma": 2.022380920890103,
                "e1": 0.0,
                "e2": 0.0,
                "center_x": 0.0,
                "center_y": 0.2914,
        ...
        kwargs_lens_light = [
            {
                "amp": 0.09140015720836722,
                "R_sersic": 2.1663040783936363,
                "n_sersic": 0.9700063614486569,
                "center_x": 0.0,
                "center_y": 0.2914,
            },
            {
                "amp": 0.8647182783851214,
                "R_sersic": 0.32239019270617386,
                "n_sersic": 1.6279835558957334,
                "center_x": 0.0,
                "center_y": 0.2914,
            },
        ]
