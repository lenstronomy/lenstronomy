...
class TestGalkin(object):
    ...
    def test_compare_power_law(self):
        ...
        npt.assert_almost_equal(sigma_v_num_log_proj / sigma_v_analytic, 1, decimal=1)
        npt.assert_almost_equal(sigma_v_num_lin_proj / sigma_v_analytic, 1, decimal=1)
    ...
    def test_projected_integral_vs_3d_rendering(self):
        ...
        # TODO: this needs to be at least accurate to 1%!!! current test only passes for about 3% precision
        npt.assert_almost_equal(sigma_v_int_method / sigma_v, 1, decimal=1)
